...
| #51 | Prefer uv over pip | Added correct guidance for `uv tool install` and `uv pip` without unsafe mechanical replacement. |
...
| #82 | ZIP download security warning | Added source verification, checksum, archive inspection, and scanning guidance. |
