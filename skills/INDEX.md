...
| [reverse-engineering/decision-framework/SKILL.md](reverse-engineering/decision-framework/SKILL.md) | High-level methodology and decision framework for reverse engineering when entry points are hidden or heavily obfuscated. |
