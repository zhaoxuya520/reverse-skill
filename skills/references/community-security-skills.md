...
| [gmh5225/awesome-game-security](https://github.com/gmh5225/awesome-game-security) | ~4250 链接 + 10 个 agent skill（2026-08-22） | **10 个 skill KEEP** 在 `game-security/references/ags/`（含 game-hacking-techniques）。README/wiki/archive **fetch** 不 vendor | reverse-skill IDENTITY：禁止 submodule 整库 |
