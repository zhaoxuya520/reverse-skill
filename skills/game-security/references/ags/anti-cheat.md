> **reverse-skill adapter** - AGS `anti-cheat-systems` under PRIMARY `game-security/` (routing **R43**). Not a second PRIMARY.
>
...
> **Fetch:** [fetch-upstream.md](fetch-upstream.md). Wiki: `wiki/overviews/anti-cheat.md`.
