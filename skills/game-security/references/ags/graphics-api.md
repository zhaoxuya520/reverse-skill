> **reverse-skill adapter** - AGS `graphics-api-hooking` under PRIMARY `game-security/` (routing **R43**). Not a second PRIMARY.
>
...
> **Fetch:** [fetch-upstream.md](fetch-upstream.md). Wiki: `wiki/overviews/graphics-api.md`.
