> **reverse-skill adapter** - AGS `reverse-engineering-tools` under PRIMARY `game-security/` (routing **R43**). Not a second PRIMARY.
>
...
> **Fetch:** [fetch-upstream.md](fetch-upstream.md). Wiki: `wiki/overviews/reverse-engineering.md`.
