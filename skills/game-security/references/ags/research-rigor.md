> **reverse-skill adapter** - AGS `game-security-research-rigor` is installed as a first-class reference under PRIMARY `game-security/` (routing **R43**). This is not a second PRIMARY and not `npx skills add`.
>
