...
- 游戏逆向、反作弊、Unity、IL2CPP、Unreal、Cheat Engine、game hacking、DMA（授权实验室；AGS 技术目录保留；非 live-title trainer 成品）
...
- 游戏逆向、反作弊、Unity、IL2CPP、Unreal、Cheat Engine、game hacking、game-security（PRIMARY R43；10 个 AGS skill 在 references/ags/；R42 预留威胁情报）
- YARA、恶意软件分析、IOC、沙箱
